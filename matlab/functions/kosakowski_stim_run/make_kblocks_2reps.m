function make_kblocks_2reps(participant, run)
...
nreps = 2; % number of  blocks per category per run
vidsperblock = 6;
...
for r = 1:nruns
    ...
    condvec = repmat([1:ncats], 1, 2);  % Each category repeats exactly 2 times
    % No need to reshuffle, this will ensure each category repeats 2 times
...
kosakowski = [2, 4, 6, 8, 10, 12, 14, 16];
